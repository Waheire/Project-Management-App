...
export const updateProjectService = async (
  ...
  if (!project) {
    throw new NotFoundException("Project not found or does not belong to the spacefied workspace")
  }
...
export const deleteProjectService = async (
  ...
  if (!project) {
    throw new NotFoundException('Project not found or does not belong to the specified worspace')
  }
